...
//           const requesturl = "http://localhost:2000/video";
//           const data ={
...
//           fetch(requesturl, {method : 'POST', header:{'Content-Type': 'application/json', 'Authorization' : localStorage.getItem('token')}, body : JSON.stringify(data)})
//           .then(response =>{
...
function Upload() {
  ...
  return (
    <div>
      <div className='SignIn'>
        <form>
            <h3 className='white'> Upload Your Video: </h3>
            <div class="mb-3">
                <label for="videoId" class="form-label white">Video Id</label>
                <input type="text" class="form-control" id="videoId" aria-describedby="emailHelp" required/>
            </div>
            <div class="mb-3">
                <label for="url" class="form-label white">URL</label>
